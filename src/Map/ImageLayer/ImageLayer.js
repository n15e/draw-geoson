...
class ImageLayer extends React.PureComponent {
    ...
    getLngLatCoordinatesFromPoints() {
        ...
        return [[nw.lng, nw.lat], [ne.lng, ne.lat], [sw.lng, sw.lat], [se.lng, se.lat]];
    }
    ...
    componentDidMount = async () => {
        ...
        const firstGlDrawLayer = map
            .getStyle()
            .layers.find(layer => layer.source && layer.source.startsWith('mapbox-gl-draw'));
